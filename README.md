...
This lab outlines the steps to create and run an open source ticketing system. This section will demonstrate my knowledge on the prerequisites and installation of the open-source help desk ticketing system osTicket.<br />
